...
(function (jQuery) {
    jQuery.fn.easyAccordion = function (options) {
        ...
        this.each(function () {
            ...
            jQuery(this).find("dt").addClass('no-more-active');
            ...
            jQuery.fn.setVariables = function () {
                ...
                dtHeight = dlHeight; // -(jQuery(this).find('dt').outerWidth(true) - jQuery(this).find('dt').width());
                slideTotal = jQuery(this).find('dt').size();
                ddWidth = dlWidth - (dtWidth * slideTotal);// -(jQuery(this).find('dd').outerWidth(true) - jQuery(this).find('dd').width());
                ddHeight = dlHeight; // -(jQuery(this).find('dd').outerHeight() - jQuery(this).find('dd').height());
            };
