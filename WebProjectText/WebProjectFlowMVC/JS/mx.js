...
function savejpgurl() {
    ...
    param.AddString("testsave.jpg");                   //  HTML组件名称
    //param.AddString("80");                           //  服务处理端口. 如：_T("80")
    param.AddString("6046");                           //  服务处理端口. 如：_T("80")
    param.AddString("testsave.jpg");                   //  文件标志名称值,表单提交事件中filename值

    param.AddLong(100);                                //  jpg文件宽度
    param.AddLong(100);                                //  jpg文件高度
    param.AddLong(16777215);                           //  jpg背景色，16777215 = 0xffffff,为白色
...
function PrintOFrameForShow() {
    var str =  '<object classid="clsid:74A777F8-7A8F-4e7c-AF47-7074828086E2" id="MxDrawXCtrl" '
        + 'codebase="http://www.mxdraw.com/MxDrawX52.CAB#version=1,0,0,1" width=100% height=90%> <param name="_Version" value="65536">'
		...
		+ '<param name="EnablePrintCmd" value="1">'
        + '<param name="FirstRunPan" value="0">'
        + '<param name="Iniset" value="LoadMrx=ExApp">'
