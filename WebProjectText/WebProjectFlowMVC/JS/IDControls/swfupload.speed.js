...
if (typeof(SWFUpload) === "function") {
	...
	SWFUpload.prototype.updateTracking = function (file, bytesUploaded) {
		...
		if (!tracking.startTime) {
			...
			// Calculate speeds
			tracking.currentSpeed = deltaBytes / (deltaTime / 1000);
			tracking.averageSpeed = tracking.bytesUploaded / ((now - tracking.startTime) / 1000);
			...
			// Update times
			tracking.timeRemaining = (file.size - tracking.bytesUploaded) / tracking.movingAverageSpeed;
