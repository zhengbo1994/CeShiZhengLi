...
{
    openAddWindow("VWaitLookList.aspx", 800, 600, "jqPerformanceComplain");
}
function btnSaveList_Click()
{
    openAddWindow("VWaitSaveList.aspx", 800, 600, "jqPerformanceComplain");
}
...
function waitDoLink(cellvalue,options,rowobject)
{
    ...
    return '<div class="nowrap"><a  href="javascript:void(0)" onclick="javascript:openAddWindow(' + vUrl + ', 0, 0, \'jqPerformanceComplain\');">' + cellvalue + '</a></div>';
}
...
function reloadData(jqGridID) {
    ...
    jqGridID = typeof jqGridID == 'undefined' ? 'jqPerformanceComplain' : jqGridID;
