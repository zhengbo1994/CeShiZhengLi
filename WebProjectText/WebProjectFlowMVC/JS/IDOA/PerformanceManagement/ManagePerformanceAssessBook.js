...
{
    var url = "VManagePerformanceAssessBookEdit.aspx";
    openModifyWindow(url, 700, 500, "jqPerformanceAssessBook");
}
...
{
    openDeleteWindow("PerformanceAssessBook", 1, "jqPerformanceAssessBook", null, { Msg: 'Y', From: 'Manage' });
}
...
{
    openDeleteWindow("PerformanceAssessBookComplete", 1, "jqPerformanceAssessBook", null, { From: 'Manage' });
}

//还原
function btnResume_Click()
{
    openResumeWindow("PerformanceAssessBook", "jqPerformanceAssessBook");
}
...
{
    openRevisionWindow("jqPerformanceAssessBook");
}
...
function setColShow(obj)
{
    if (obj.value == 'Y')
    {
        ...
        $("#jqPerformanceAssessBook").showCol("DeleteEmployeeName");
        $("#jqPerformanceAssessBook").showCol("DeleteDate");
        $("#jqPerformanceAssessBook").showCol("DeleteRemark");
    }
    ...
    else
    {
        ...
        $("#btnDelete_tb").show();
        $("#btnAdjust_tb").show();
        $("#jqPerformanceAssessBook").hideCol("DeleteEmployeeName");
        $("#jqPerformanceAssessBook").hideCol("DeleteDate");
        $("#jqPerformanceAssessBook").hideCol("DeleteRemark");
    }
}
...
{
    var url = "'VPerformanceAssessBookBrowse.aspx?ID=" + rowobject[0] + "'";
    return '<a href="#ShowPerformanceAssessBookBrowse" onclick="javascript:openWindow(' + url + ',800, 600)">' + cellvalue + '</a>';
}
