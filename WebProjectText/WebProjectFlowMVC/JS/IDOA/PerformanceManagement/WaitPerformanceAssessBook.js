...
{   
    openAddWindow("VWaitLookList.aspx", 800, 600, "jqPerformanceAssessBook");
}
function btnSaveList_Click()
{
    openAddWindow("VWaitSaveList.aspx", 800, 600, "jqPerformanceAssessBook");
}
...
function waitDoLink(cellvalue,options,rowobject)
{
    ...
    return '<div class="nowrap"><a  href="#Show" onclick="javascript:openAddWindow(' + vUrl + ', 0, 0, \'jqPerformanceAssessBook\');">' + cellvalue + '</a></div>';
}
...
function reloadData(jqGridID)
{
    ...
    jqGridID = typeof jqGridID == 'undefined'?'jqPerformanceAssessBook':jqGridID;
