(function (a)
{
    a.fn.webwidget_slideshow_dot = function (p)
    {
        ...
        function init()
        {
            ...
            x.find(".thumb_box").append('<span><img src="'+d+'carousel_back_normal.png" alt="上一个"  class="thumb_p"/></span>');
            ...
            x.find(".thumb_box").append('<span><img src="'+d+'carousel_next_normal.png" alt="下一个"  class="thumb_n"/></span>');
        ...
        function play()
        {
            ...
            //            x.closest("#divNewListAndImage").next().text(x.find("ul:first").find("a:eq(" + w + ")").attr("title"));
            var t = x.closest("#divNewListAndImage").next().children("span").html(x.find("ul:first").find("a:eq(" + w + ")").attr("title"));

            if (t.length != 0 && t.width() > 152)
            {
                t.html("<marquee scrollamount='5'>" + t.html() + "</marquee>");
            }
            v = setTimeout(play, m)
        }
        function stop()
