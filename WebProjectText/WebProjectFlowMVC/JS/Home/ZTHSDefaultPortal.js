$(function ()
{
    ...
    $(".bbs-btn").click(function ()
    {
        ...
        var that = this;
        ajaxRequest("/" + rootUrl + "/Home/Custom/ZTHSDefaultPortal.aspx", query, "json", function (data)
        {
            if (data.Success == "Y")
            {
...
{
    openWindow("../../IDOA/InformationIssue/VInformationIssueBrowseMap.aspx?IICID=7C8C9BA6-2337-4FB3-A566-4C48C66B5C30&IDM_CD=5&IDM_ID=7EEBC3BF-2D08-49FA-99D9-AB91C1A5853D&CorpID=TotalCompany", 0, 0);
}
...
{
    openWindow("../../IDOA/InformationIssue/VInformationIssue.aspx?IICID=FB1B776C-046E-499F-A922-1801A1EF8F4A&IDM_CD=28&IDM_ID=1719F8BA-699E-41AD-870A-4C049D1E90F1", 0, 0);
}
...
function showMoreMH()
{
    openWindow("../../IDOA/InformationIssue/VInformationIssuePicMap.aspx?IICID=8B106DBF-3FE1-4A26-99C9-C4FAAD6241E5&IDM_CD=61", 0, 0);  
}
...
function showMoreKnowledge()
{
    openWindow("../../IDOA/InformationIssue/VInformationIssue.aspx?IICID=FB1B776C-046E-499F-A922-1801A1EF8F4A&IDM_CD=28&IDM_ID=222B9AD0-4A09-44D7-AB23-5BAA84E70E4A", 800, 600);
};
...
{
    openWindow("/" + rootUrl + "/IDOA/Bylaw/VRegimeMap.aspx", 800, 600);
}
//查看制度
