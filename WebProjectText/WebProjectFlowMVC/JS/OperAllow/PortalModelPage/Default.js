...
{
    parent.parent.window.location = "../../IDOA/EnCulture/Bulletin/VBulletin.aspx";
}
...
{
    parent.parent.window.location = "../../IDOA/EnCulture/News/VNews.aspx";
}
...
function onDuty(btn)
{
    ...
    ajaxRequest("VDefault.aspx", { AjaxRequest:true, Aim:"4"}, "text", finishOnDuty);
}
...
{
    setAjaxContainer(btn);
    ajaxRequest("VDefault.aspx", { AjaxRequest:true, Aim:"5"}, "text", finishOffDuty);
}
...
{
    parent.parent.window.location = "../../IDOA/MyWork/VOutGo.aspx";
}
...
{
    parent.parent.window.location = "../../IDOA/IntraMail/VMailReceive.aspx";
}
...
function searchKM()
{
    ...
    ajaxRequest("VDefault.aspx", { AjaxRequest:true, Aim:kmAim, KMKw:kw}, "html", refreshKM);
}
...
{
    parent.parent.window.location = "../../IDOA/EnCulture/bbs/VForumMainBrowse.aspx";
}
...
function loadSchedule()
{
    ...
    ajaxRequest("VDefault.aspx", { AjaxRequest:true, Aim:"3", CalDate:ym}, "html", refreshSchedule);
}
...
{
    parent.parent.window.location = "../../IDOA/MyWork/MySchedule/VMyScheduleSetting.aspx";
}
