...
var CanvasView = (function () {
    function CanvasView() {
        ...
        win.on("resize", function () {
            CanvasView.Canvas.height(function () {
                return CanvasView.TopHeader.css("display") === "none" ? win.height() : win.height() - $(this).position().top - 10;
            });
    ...
    CanvasView.ReLoadPortalLayout = function (portalId) {
        try {
            ...
            LoadPortalLayout(portalId, function (result) {
                ...
                var win = $(window);
                CanvasView.Canvas.height(function () {
                    return CanvasView.TopHeader.css("display") === "none" ? win.height() : win.height() - CanvasView.Canvas.position().top - 10;
                });
