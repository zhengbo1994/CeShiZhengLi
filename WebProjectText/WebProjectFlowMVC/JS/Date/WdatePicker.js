...
function getDateTheme(win)
{
    ...
    try
    {
        ...
        if (!theme)
        {
            if (win.opener)
            {
                theme = getDateTheme(win.opener);
            }
            else if (win.dialogArguments)
            {
                theme = getDateTheme(win.dialogArguments);
            }
        }
    }
    catch (e)
