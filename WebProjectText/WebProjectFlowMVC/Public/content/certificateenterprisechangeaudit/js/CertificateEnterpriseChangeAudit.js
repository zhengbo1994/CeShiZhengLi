...
$(function () {
    ...
    var $gridMain = $("#gridCertificateEntChangAudit_main");
    var $pagerMain = $("#pagerCertificateEntChangAudit_main");
    ...
    var $divCheckInfo = $("#divCertificateEntChangeAudit_CheckInfo");
    var $mdlCheckInfo = $("#mdlCertificateEntChangeAudit_CheckInfo");
    ...
    var initButtonArea = function () {
        ...
        var initCertificateEntChange_EntChangeAudit = function () {
            $("#btnCertificateEntChange_EntChangeAudit").on("click", function () {
