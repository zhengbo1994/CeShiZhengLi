...
$(function () {
    ...
    var controllerName = "EmployeeCheck";
    var $divQueryArea = $('#divEmployeeCheck_QueryArea');
    var $gridMain = $("#gridEmployeeCheck_main");
    var $pagerMain = $("#pagerEmployeeCheck_main");

    var $divEmployeeCheck_CheckInfo = $("#divEmployeeCheck_CheckInfo");
    var $mdlEmployeeCheck_CheckInfo = $("#mdlEmployeeCheck_CheckInfo");

    var $divEmployeeCheck_ReturnInfo = $("#divEmployeeCheck_ReturnInfo");
    var $mdlEmployeeCheck_ReturnInfo = $("#mdlEmployeeCheck_ReturnInfo");

    var $divTrainingRecord_Info = $("#divEmployeeCheck_TrainingRecordInfo");
    var $mdlTrainingRecord_Info = $("#mdlEmployeeCheck_TrainingRecordInfo");

    var $mdlTrainingRecord_StudyInfo = $("#mdlEmployeeCheck_TrainingRecordStudyInfo");
    var $divTrainingRecord_StudyInfo = $("#divEmployeeCheck_TrainingRecordStudyInfo");

    var initQueryArea = function () {
        var initQueryButton = function () {
            $("#btnEmployeeCheck_Query").on("click", function () {
                var queryData = {};
    ...
    var initMainGrid = function () {
        ...
        $gridMain.jqGrid({
            ...
            multiboxonly: true,
            postData: queryData,
            colNames: ["EmployeeId", "姓名", "性别", "年龄", "身份证号", "企业名称", "职务", "技术职称", "报考行业", "报考科目", "注册建造师证书编号", "所在城市", "报考城市", "培训类型", "培训机构", "学习课时", "练习最高分", "审核状态", "审核人", "审核日期", "操作"],
            colModel: [
                    ...
                    { name: "EnterpriseCity", index: "EnterpriseCity", align: "center", width: 80 },
    ...
    var initButtonArea = function () {
        var initCheckButton = function () {
            $("#btnEmployeeCheck_Check").on("click", function () {
    ...
    var initCheckedModal = function () {
        ...
        var initCheckedButton = function () {
            var CheckedEmployee = function (passFlag) {
                ...
                if ((checkedMark == "同意" || isNull(checkedMark)) && passFlag == false) {
                    alert("请填写退回意见");
                    return false;
                }
            ...
            $("#btnEmployeeCheck_CheckedPass").on("click", function () {
                CheckedEmployee(true);
            });
            $("#btnEmployeeCheck_CheckedNoPass").on("click", function () {
