...
(function ($) {
    ...
    $.jqPagination = function (el, options) {
        ...
        base.updateInput = function (prevent_paged) {
            ...
            var current_page = parseInt(base.options.current_page, 10);
            var page_size = parseInt(base.options.page_size, 10);
            ...
            if (prevent_paged !== true) {
                var page = { current_page: current_page, page_size: page_size, data: base.data };
        ...
        base.refresh = function () {
            base.setPage(base.options.current_page);
            return base;
        };

        base.setData = function (data) {
            if (undefined != data) {
                base.options.data = data;
            }
            return base;
        };

        var requestData = function () {
            var postData = base.options.data;
            postData.current_page = base.options.current_page;
            postData.page_size = base.options.page_size;
            $.ajax({
                ...
                success: function (jresult) {
                    innerPaged(jresult);
                    base.data = jresult.data;
                },
                error: function (xmlHttpRequest, errMsg, ex) {
                    console.error("error occurred when request data :" + errMsg);
                }
            });
        };

        //update input after ajax request
        var innerPaged = function (jdata) {
            if (jdata) {
                if (undefined != jdata.max_page) {
                    base.setMaxPage(jdata.max_page, true);
                }
            }
        };
