...
namespace RepositoryDal.Repository.T
{
    /// <summary>
    /// 描 述：定义仓储模型中的数据标准操作
    /// </summary>
    /// <typeparam name="TEntity">动态实体类型</typeparam>
    public class Repository<T> : RepositoryDal.IRepository.T.IRepository<T> where T : class,new()
    {
        #region 构造
        public IDatabase db;
        ...
        #region 事物提交
        public RepositoryDal.IRepository.T.IRepository<T> BeginTrans()
        {
            db.BeginTrans();
            return this;
        }
